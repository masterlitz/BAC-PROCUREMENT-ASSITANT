...
import SourceDocumentsView from './SourceDocumentsView';
import AppView from './AppView';
import AppCseView from './AppCseView'; // New Import
...
const PpmpConsolidatorTab: React.FC<PpmpConsolidatorTabProps> = ({ isVisible, onClose }) => {
    ...
    const appCseRef = useRef<{ exportToPdf: () => void; exportToExcel: () => void; }>(null); // New Ref
    ...
    const handleExportPdf = () => {
        switch (activeView) {
            ...
            case 'app-cse': appCseRef.current?.exportToPdf(); break; // New Case
     ...
     const handleExportExcel = () => {
        switch (activeView) {
            ...
            case 'app-cse': appCseRef.current?.exportToExcel(); break; // New Case
    ...
    const menuItems = [
        ...
        { key: 'app-cse', label: 'APP-CSE', icon: '📝' } // New Menu Item
    ];
    ...
    const mainContent = () => {
        ...
        switch(activeView) {
            ...
            case 'app-cse': return <AppCseView ref={appCseRef} consolidatedItems={consolidatedItems} />; // New Case
            default: return null;
        }
    };
